...
public class Main {
    ...
    private static void createWalletInvestment() {
        ...
        var investmentWallet = investmentRepository.initialInvestment(account, investmentId);
    ...
    private static void checkHistory() {
        ...
        try {
            ...
            sortedHistory.forEach((k, v) -> {
                System.out.println(k.format(java.time.format.DateTimeFormatter.ISO_DATE_TIME));
